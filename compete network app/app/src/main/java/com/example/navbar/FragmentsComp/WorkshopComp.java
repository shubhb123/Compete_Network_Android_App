...
public class WorkshopComp extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View view= inflater.inflate(R.layout.fragment_workshop_comp,container,false);
        recyclerView= view.findViewById(R.id.recyclerallw);


        list.add(new ModelComp(R.drawable.comp1,"Workshops","L'oreal"));
