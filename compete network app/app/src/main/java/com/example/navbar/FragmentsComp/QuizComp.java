...
public class QuizComp extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View view= inflater.inflate(R.layout.fragment_quiz_comp,container,false);
        recyclerView= view.findViewById(R.id.recyclerallq);


        list.add(new ModelComp(R.drawable.comp1,"Quizes","L'oreal"));
