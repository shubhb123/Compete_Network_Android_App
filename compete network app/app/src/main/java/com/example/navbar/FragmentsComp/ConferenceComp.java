...
public class ConferenceComp extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View view= inflater.inflate(R.layout.fragment_conference_comp,container,false);
        recyclerView= view.findViewById(R.id.recyclerallc);


        list.add(new ModelComp(R.drawable.comp1,"Conference","L'oreal"));
