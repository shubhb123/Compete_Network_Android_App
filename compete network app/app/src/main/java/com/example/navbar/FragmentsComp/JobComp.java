...
public class JobComp extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View view= inflater.inflate(R.layout.fragment_job_comp,container,false);
        recyclerView= view.findViewById(R.id.recyclerallj);


        list.add(new ModelComp(R.drawable.comp1,"Jobs","L'oreal"));
