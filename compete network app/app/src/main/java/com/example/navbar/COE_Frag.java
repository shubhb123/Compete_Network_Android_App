...
public class COE_Frag extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View v= inflater.inflate(R.layout.fragment_c_o_e_, container, false);
    ...
    private void loadlist() {
        list.add(new ModelComp(R.drawable.comp3,"COE Event","IIT Delhi"));
