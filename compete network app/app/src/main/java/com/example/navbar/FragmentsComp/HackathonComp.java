...
public class HackathonComp extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View view= inflater.inflate(R.layout.fragment_hackathon_comp,container,false);
        recyclerView= view.findViewById(R.id.recyclerallh);

        list.add(new ModelComp(R.drawable.comp1,"Hackathon","L'oreal"));
        list.add(new ModelComp(R.drawable.comp1,"Loreal Brandstorm","L'oreal"));
        list.add(new ModelComp(R.drawable.comp2,"Bajaj CEO Challenge","Bajaj"));
        ...
        AdapterComp adapterComp= new AdapterComp(list, getContext());
        recyclerView.setAdapter(adapterComp);
