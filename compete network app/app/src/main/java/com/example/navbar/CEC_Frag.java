 ...
 */
public class CEC_Frag extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View v = inflater.inflate(R.layout.fragment_c_e_c_, container, false);
    ...
    private void loadlist() {
        list.add(new ModelComp(R.drawable.comp4, "CEC Event", "Google"));
