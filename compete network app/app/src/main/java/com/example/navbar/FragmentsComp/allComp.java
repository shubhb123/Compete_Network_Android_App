...
public class allComp extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View view= inflater.inflate(R.layout.fragment_all_comp,container,false);
        recyclerView= view.findViewById(R.id.recycleralla);


        list.add(new ModelComp(R.drawable.comp1,"All Competitions","L'oreal"));
