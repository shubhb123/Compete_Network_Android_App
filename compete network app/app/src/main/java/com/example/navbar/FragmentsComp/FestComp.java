...
public class FestComp extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View view= inflater.inflate(R.layout.fragment_fest_comp,container,false);
        recyclerView= view.findViewById(R.id.recyclerallf);


        list.add(new ModelComp(R.drawable.comp1,"Festivals","L'oreal"));
